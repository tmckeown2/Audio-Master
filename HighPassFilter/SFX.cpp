...
private:
	...
	const char* name = "High Pass Filter";
...
void Sfx::DoSFX(ComplexArray& arr)
{
	...
	// Remove all frequencies below the threshold
	...
	for (int i = 0; i < arr.size(); ++i)
	{
		...
		// Then flatten the peak if i, the frequency of the peak we are analysing, is less than the threshold
